...
public class SpellSaveCommand extends Command implements IResponder {
    ...
    {
        spellService.save(event.spell, this);
    }
    ...
    public function result(data:Object):void
    {
        ...
        dispatch(new SpellEvent(SpellEvent.SAVE_SUCCESS, data as Spell));
    }
    ...
    {
        CONFIG::debugtrace{ trace("SpellSaveCommand::fault: " + info.toString()); }
    }
}
}
